<?php /*a:2:{s:89:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/controller/Sys/view/action/info.html";i:1602574462;s:80:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/common/_container.html";i:1602393978;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
							...
							<!-- form start -->
								...
								<div class="form-group layui-form">
									...
									<div class="col-sm-9">
										...
										<input value="<?php echo $query['field']; ?>" data-type="<?php echo $query['type']; ?>" name="fields" lay-filter="hope" class="checkbox" type="checkbox" <?php if(in_array($query['field'],explode(',',$info['fields']))): ?>checked<?php endif; ?> title="<?php echo $query['name']; ?>">
								...
								<div class="form-group layui-form">
									...
									<div class="col-sm-9">
										<input name="button_status" value="1" type="radio" <?php if($info['button_status'] == 1): ?>checked<?php endif; ?> title="是">
										<input name="button_status" value="0" type="radio" <?php if($info['button_status'] == 0): ?>checked<?php endif; ?> title="否">
									</div>
								</div>
								...
								<div class="form-group layui-form">
									...
									<div class="col-sm-9">
										<select lay-ignore name="lable_color" class="form-control" id="lable_color">
											<option value="primary" style="background-color:#1DB394" <?php if($info['lable_color'] == 'primary'): ?>selected<?php endif; ?>>primary</option>
											<option value="success" style="background-color:#1E84C6" <?php if($info['lable_color'] == 'success'): ?>selected<?php endif; ?>>success</option>
											<option value="info" style="background-color:#25C6C8" <?php if($info['lable_color'] == 'info'): ?>selected<?php endif; ?>>info</option>
											<option value="warning" style="background-color:#F8AC5A" <?php if($info['lable_color'] == 'warning'): ?>selected<?php endif; ?>>warning</option>
											<option value="danger" style="background-color:#D7524B" <?php if($info['lable_color'] == 'danger'): ?>selected<?php endif; ?>>danger</option>
										</select>
									</div>
								</div>
								<div class="form-group">
						...
						<div class="layui-tab-item">
							...
							<div class="form-group layui-form">
								...
								<div class="col-sm-9">
									...
									<input name="is_view_create" value="1" type="radio" <?php if($info['is_view_create'] == 1): ?>checked<?php endif; ?> title="是">
									<input name="is_view_create" value="0" type="radio" <?php if($info['is_view_create'] == 0): ?>checked<?php endif; ?> title="否">
								</div>
							</div>
							<div class="form-group layui-form">
								...
								<div class="col-sm-9">
									...
									<input name="is_view" value="1" type="radio" <?php if($info['is_view'] == 1): ?>checked<?php endif; ?> title="是">
									<input name="is_view" value="0" type="radio" <?php if($info['is_view'] == 0): ?>checked<?php endif; ?> title="否">
								</div>
							</div>
							<div class="form-group layui-form">
									...
									<div class="col-sm-9">
										...
										<input name="select_type" value="1" type="radio" <?php if($info['select_type'] == 1): ?>checked<?php endif; ?> title="单选">
										<input name="select_type" value="2" type="radio" <?php if($info['select_type'] == 2): ?>checked<?php endif; ?> title="多选">
									</div>
								</div>
							<div class="form-group layui-form">
							...
							<div class="form-group layui-form">
								...
								<div class="col-sm-9">
									<input type="text" id="bs_icon" name="bs_icon" value="<?php echo $info['bs_icon']; ?>" class="form-control" placeholder="请输入图标名称">
							...
							<div class="form-group layui-form">
								...
								<div class="col-sm-9">
									<input type="text" id="jump" name="jump" value="<?php echo $info['jump']; ?>"  class="form-control" placeholder="请输入跳转地址">
								</div>
							</div>
						</div>
						</div>
