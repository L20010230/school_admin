<?php /*a:1:{s:74:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/login/index.html";i:1646143286;}*/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="/static/login/assets/css/admin.css" media="all">
    <link rel="stylesheet" href="/static/login/assets/css/login.css" media="all">
...
<style type="text/css">
    body{
        background-image: url("/static/login/images/denglu.jpg");
    ...
    <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
        ...
        <div class="layadmin-user-login-main">
            <div class="layadmin-user-login-box layadmin-user-login-header">
                <h2><?php echo config('base.site_title'); ?></h2>
            </div>
                        ...
                        <div class="layui-row">
                            ...
                            <div class="layui-col-xs5">
                                <div style="margin-left: 10px;">
                                    <img id="img" class="verifyImg layadmin-user-login-codeimg" id="LAY-user-get-vercode" onclick="this.src=this.src+'?c='+Math.random();" src="<?php echo url('admin/Login/verify'); ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
