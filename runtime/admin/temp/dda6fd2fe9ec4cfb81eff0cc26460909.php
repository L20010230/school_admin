<?php /*a:2:{s:73:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/user/index.html";i:1609829222;s:80:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/common/_container.html";i:1602393978;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="ibox-content"> 
				<div class="row row-lg"> 
					<div class="col-sm-12"> 
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<select class="form-control" id="role_id">
										...
										<?php $_result=htmlOutList(\think\facade\Db::connect('mysql')->query('select role_id,name,pid from cd_role'),false);if($_result)$_result = formartList(explode(",","role_id,pid,name,name"),$_result);foreach($_result as $key=>$sql):?>
						...
						<?php if(in_array('admin/User/add',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="add" class="btn btn-primary button-margin" onclick="CodeGoods.add()">
						<i class="fa fa-plus"></i>&nbsp;添加
						</button>
						<?php endif; if(in_array('admin/User/update',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="update" class="btn btn-success button-margin" onclick="CodeGoods.update()">
						<i class="fa fa-edit"></i>&nbsp;修改
						</button>
						<?php endif; if(in_array('admin/User/updatePassword',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						...
						<?php endif; if(in_array('admin/User/delete',session('admin.nodes')) || session('admin.role_id') == 1): ?>
...
<script>
	...
	CodeGoods.buttonFormatter = function(value,row,index) {
		if(row.user_id){
			var str= '';
			<?php if(in_array('admin/User/update',session('admin.nodes')) || session('admin.role_id') == 1): ?>
