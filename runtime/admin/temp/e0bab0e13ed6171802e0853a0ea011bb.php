<?php /*a:2:{s:92:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/controller/Sys/view/menu/api_index.html";i:1600140078;s:80:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/common/_container.html";i:1602393978;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
					...
					<div class="col-sm-12">
						<div class="btn-group-sm" id="CodeGoodsTableToolbar" role="group">
							...
							<button type="button" class="btn btn-warning button-margin" onclick="CodeGoods.actionlist()">
								<i class="glyphicon glyphicon-plus"></i>&nbsp;接口方法
							</button>
...
<script>
	...
	CodeGoods.initColumn = function () {
 		return [
			...
			{title: '排序', field: 'menu_id', visible: true, align: 'center', valign: 'middle',formatter: 'CodeGoods.arrowFormatter'},
 			{title: '分组名称', field: 'cname', visible: true, align: 'lelf', valign: 'middle'},
			...
			{title: '主键', field: 'pk_id', visible: true, align: 'lelf', valign: 'middle'},
			{title: '是否生成代码', field: 'is_create', visible: true, align: 'center', valign: 'middle',formatter: 'CodeGoods.statusFormatter'},
	...
	CodeGoods.add = function () {
		var index = layer.open({type: 2,title: '创建分组',area: ['900px', '100%'],fix: false, maxmin: true,content: Feng.ctxPath + '/Sys.Menu/add?app_id=<?php echo $app_id; ?>'});
	...
	$(function() {
		...
		var table = new BSTable(CodeGoods.id, Feng.ctxPath + "/Sys.Menu/index?app_id=<?php echo $app_id; ?>",defaultColunms,50);
		table.setPaginationType("server");
		table.setQueryParams(CodeGoods.formParams());
		CodeGoods.table = table.init();
		$('#CodeGoodsTableToolbar').navfix(0,999); 
	});
</script>
<script type="text/javascript">
