<?php /*a:2:{s:76:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/student/index.html";i:1669714542;s:80:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/common/_container.html";i:1602393978;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="ibox-content"> 
				<div class="row row-lg"> 
					<div class="col-sm-12"> 
						...
						<?php if(in_array('admin/Student/add',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="add" class="btn btn-primary button-margin" onclick="CodeGoods.add()">
						<i class="fa fa-plus"></i>&nbsp;添加
						</button>
						<?php endif; if(in_array('admin/Student/update',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="update" class="btn btn-success button-margin" onclick="CodeGoods.update()">
						<i class="fa fa-pencil"></i>&nbsp;修改
						</button>
						<?php endif; if(in_array('admin/Student/delete',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="delete" class="btn btn-danger button-margin" onclick="CodeGoods.delete()">
						<i class="fa fa-trash"></i>&nbsp;删除
						</button>
						<?php endif; if(in_array('admin/Student/view',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="view" class="btn btn-info button-margin" onclick="CodeGoods.view()">
						<i class="fa fa-eye"></i>&nbsp;查看详情
						</button>
						<?php endif; if(in_array('admin/Student/dumpData',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="dumpData" class="btn btn-warning button-margin" onclick="CodeGoods.dumpData()">
						<i class="fa fa-download"></i>&nbsp;导出
						</button>
						<?php endif; if(in_array('admin/Student/import',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="import" class="btn btn-warning button-margin" onclick="CodeGoods.import()">
						<i class="fa fa-upload"></i>&nbsp;导入
						</button>
						<?php endif; if(in_array('admin/Student/change_password',session('admin.nodes')) || session('admin.role_id') == 1): ?>
...
<script>
	...
	CodeGoods.buttonFormatter = function(value,row,index) {
		if(row.student_id){
			var str= '';
			<?php if(in_array('admin/Student/update',session('admin.nodes')) || session('admin.role_id') == 1): ?>
