<?php /*a:2:{s:73:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/member/add.html";i:1669688383;s:80:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/common/_container.html";i:1602393978;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				...
				<!-- form start -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="user_name" value="" name="user_name" class="form-control" placeholder="请输入账号">
						</div>
					</div>
					<div class="form-group">
