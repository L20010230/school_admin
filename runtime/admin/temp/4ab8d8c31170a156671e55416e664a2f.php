<?php /*a:2:{s:94:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/controller/Sys/view/menu/admin_index.html";i:1609664854;s:80:"/www/wwwroot/senior.test.jiayuanxueyuan.cn/app/admin/view/common/_container.html";i:1602393978;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="row row-lg">
					<div class="col-sm-12">
						<div class="btn-group-sm" id="CodeGoodsTableToolbar" role="group">
							...
							<select style="border:1px solid #ddd; width:180px; height:24px;" class="btn chosen" id="connect">
...
<script>
	...
	$(function(){
		$('#connect').change(function() {
			var ajax = new $ax(Feng.ctxPath + "/Sys.Menu/getTableList", function (data) {
				...
				$("#tableData").html(html);
				$("#tableData").trigger("chosen:updated");
			})
			ajax.set('connect',$("#connect").val());
			ajax.start();
		})
	})
